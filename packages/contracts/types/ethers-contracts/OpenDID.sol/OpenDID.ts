...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedLogDescription, TypedListener, TypedContractMethod } from "../common.js"
  ...
  export interface OpenDIDInterface extends Interface {
    getFunction(nameOrSignature: "CHAIN_ID" | "ENS_REGISTRY" | "FILECOIN_CONTRACT" | "OPENDID_KEY" | "generateClaimMessage" | "generateRegistrationMessage" | "getDID" | "getNamehash" | "getNonce" | "hasDID" | "incrementNonce" | "nonces" | "registerDID"): FunctionFragment;
...
encodeFunctionData(functionFragment: 'OPENDID_KEY', values?: undefined): string;
...
decodeFunctionResult(functionFragment: 'OPENDID_KEY', data: BytesLike): Result;
...
decodeFunctionResult(functionFragment: 'registerDID', data: BytesLike): Result;
  ...
  export interface OpenDID extends BaseContract {
    
    connect(runner?: ContractRunner | null): OpenDID;
    waitForDeployment(): Promise<this>;

    interface: OpenDIDInterface;
  ...
  removeAllListeners<TCEvent extends TypedContractEvent>(event?: TCEvent): Promise<this>
    ...
    OPENDID_KEY: TypedContractMethod<
      [],
      [string],
      'view'
    >
...
getFunction(nameOrSignature: 'FILECOIN_CONTRACT'): TypedContractMethod<
      ...
      'view'
    >;
getFunction(nameOrSignature: 'OPENDID_KEY'): TypedContractMethod<
      [],
      [string],
      'view'
    >;
